  ...
  return (
    <Container>
      <FooterWrapper>
        <Row>
          <Col>
            ...
            <SiteLink href='https://github.com/Aparna873' target='_blank'>
              Github
            </SiteLink>
            <SiteLink
            ...
            <SiteLink href='https://x.com/AparnaShuk20291?t=javDxBI3i73G0uwyqMFWbQ&s=08' target='_blank'>
              Twitter
            </SiteLink>
          </Col>
          {/* col 2 */}
      ...
      <Attribution>
        ...
        <a
          href='https://github.com/Aparna873'
          rel='noreferrer'
          target='_blank'
        >
          Aparna Shukla
